...
$message='
		<html>
				...
				<body>
				 <div>Bonjour,</div>
				 Vous avez passé votre réclamation dans notre site design cuisine . 
				 <td align="center">
							<font size="2">
...
$mail->AltBody = "Service aprés vente: Design Cuisine";

//Attach an image file
//$mail->addAttachment('images/phpmailer_mini.png');

echo "<script type='text/javascript'> window.location='../views/reclamation.php';
 alert('votre service a été bien passé. Merci pour votre fidélité');
 </script>";
