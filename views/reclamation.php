...
<head>
    ...
    <script type="text/javascript" src="sab.js"></script>
</head>
...
<div >
  <select class="form-control mb-30" name="description">
    ...
    <option  value="Probleme de performance d'un produit">Problème de performance d'un produit</option>
    <option  value="Autre">Autre</option>
  </select>
</div>
<!--<p>Entrez un nombre d'étoile qui peut designer votre satisfaction globale :</p>
<div >
  <select class="form-control mb-30" name="nbre">
    <option  value="select">Select :</option>
...
<input type="hidden" name="nbre" class="form-control mb-30" width="800px" value="<?php echo "0"; ?>">
<input type="submit" name="ajouter" value="ajouter" class="btn akame-btn btn-3 mt-15 active" style="margin-left: 470px;">
<p id="error"> </p>
     </form> </br></br></br>
<!--<form action="modifier_reclamation.php">
<input type="submit" name="modifier" value="modifier" class="btn akame-btn btn-3 mt-15 active" style="margin-left: 470px;">
</form>-->

   <!--<form method="POST" action="modifier_reclamation.php" class="akame-contact-form border-0 p-0" >
    <p>Pour modifier votre reclation vous devez entrer l'identifiant de votre commande :</p>
    <input type="text" name="idd" class="form-control mb-30" width="800px" placeholder="ID Commande">
    <input type="submit" name="modifier" value="modifier" class="btn akame-btn btn-3 mt-15 active" style="margin-left: 470px;">
